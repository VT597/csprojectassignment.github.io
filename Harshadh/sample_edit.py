...
login_frame = Frame(win1, bg="white")
login_frame.pack(expand=True)

heading= Label(win1,text="LOGIN PAGE", font=("Lato",23,"bold"),bg='azure',fg='dark slate blue')
...
Frame(win1,width=222,height=2,bg="dark slate blue").place(x=600,y=200)
...
Frame(win1,width=222,height=2,bg="dark slate blue").place(x=600,y=260)
...
newaccountButton= Button(win1, text= 'Create New Account',font=("Open sans",9,"bold underline")
                         ,bg= "White", fg="midnight blue" ,cursor='hand2' ,activebackground= 'white',
                         activeforeground='midnight blue',bd=0,width=17)
